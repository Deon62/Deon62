...
**Computer Science Graduate | AI Engineer | Entrepreneur** Exploring **Quantum Computing**, **Blockchain**, and **Smart Contracts** (Rust + Stellar).  
Speaker at **ETH Safari 2025** | Founder of **Ardena** (Next-gen car rental & transport infrastructure).  
Passionate about building intelligent systems that merge AI with Web3 to create high-trust marketplaces.

📫 Reach me: **[https://deonhq.xyz](https://deonhq.xyz)**# Hi, I'm Deon (@Deon62)
...
## Current Focus
  ...
  - **Ardena:** Building high-trust infrastructure for the future of car rentals, merging AI verification with seamless payments.
  - **AI Agents:** Developing multi-tool, voice-enabled, and modular agents (like **Liora**).
  - **Stellar Soroban:** Implementing smart contracts for automated escrow and decentralized finance.
  - **ImpactHub:** Actively developing and scaling impact-driven tech (Dev1, Dev2).
...
## Featured Projects
  ...
  - **[Ardena](https://www.google.com/search?q=%23)** – Trust-based marketplace for car rentals using real-time verification and on-chain payments.
  - **[Liora](https://www.google.com/search?q=%23)** – Proactive AI agent designed to initiate and maintain natural conversations.
  - **[Stellar Smart Contracts](https://www.google.com/search?q=%23)** – Experimental Soroban/Rust implementations for decentralized finance.
  - **[AI Agents 101 Course](https://www.google.com/search?q=%23)** – A comprehensive learning series on the architecture and deployment of AI agents.
